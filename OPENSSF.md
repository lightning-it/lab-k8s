...
Enrolled in OpenSSF Best Practices. The badge is emitted from the central release-model inventory using project `13885` with target level `passing`.
...
linting, syntax validation, release dry-run checks, and secret-safe workflow review.
